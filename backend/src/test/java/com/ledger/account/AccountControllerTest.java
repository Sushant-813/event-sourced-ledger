 ...
 *
 * Uses {@code standaloneSetup} with {@link GlobalExceptionHandler} registered as controller
 * advice so that all 14 HTTP-layer scenarios can be exercised without loading a full Spring
