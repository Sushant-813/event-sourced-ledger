...
class LedgerServiceImplTest {
        ...
        void shouldRejectNullTransaction() {
                ...
                assertThrows(
                                IllegalArgumentException.class,
                                () -> ledgerService.recordTransaction(null, entries));
        ...
        @Test
        void shouldRejectCollectionWithNullEntry() {
                // Arrange
                Transaction transaction = new Transaction(
                                "TXN-013",
                                TransactionType.DEPOSIT,
        ...
        @Test
        void shouldRejectEntryWithNullEntryType() {
                // Arrange
                Transaction transaction = new Transaction(
                                "TXN-014",
                                TransactionType.DEPOSIT,
        ...
        @Test
        void shouldRejectEntryBelongingToDifferentTransaction() {
                // Arrange
                Transaction transaction = new Transaction(
                                "TXN-015",
                                TransactionType.DEPOSIT,
